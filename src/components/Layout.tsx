            ...
            {user ? (
              <div className="flex items-center gap-4 ml-4 pl-4 border-l border-zinc-800">
                <div className="flex items-center gap-2 text-zinc-300">
                  ...
                  {user.isSubscriber && (
                    <span className="bg-primary/20 text-primary text-[10px] px-1.5 py-0.5 rounded border border-primary/20">PRO</span>
                  )}
                </div>
                <button 
                  onClick={logout}
            ...
            {user ? (
              <div className="flex flex-col gap-4 pt-4 border-t border-zinc-900">
                ...
                <button 
                  ...
                  className="text-left text-zinc-500 hover:text-white flex items-center gap-2"
                >
